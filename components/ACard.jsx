...
const evTime = format(new Date(eventTime), 'DD. MM. YYYY. [u] HH:mm'); 
    ...
    return (
        ...
        <div className="w-full mx-auto overflow-hidden bg-white rounded-lg shadow-lg my-3 flex flex-col justify-between cursor-pointer hover:scale-105 transition-transform duration-300">
            ...
            <div className="relative bg-itaGreen hover:bg-[#000000] transition-colors  duration-500">
                ...
                <div className="w-2/3 font-bold">{evTime}</div>
                </div>
            <Image src={'https:'+ url} 
